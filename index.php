    ...
    <body>
        <div id="app">
            ...
            <div id="puzzle-page" data-role="page" class="pg-page">
                ...
                <div class="bean_notification_window">
                ...
                <div class="mbj_capsule_container autocentered hidden">
                ...
                <div class="mbj_notification_container autocentered" id="mbj_notification_container_login">
                    ...
                    <div class="mbj_notification_pane_selectors">
                        <div class="mbj_notification_pane_selector active_selector">
                            <h2>Login</h2>
                        </div>
                        <div class="mbj_notification_pane_selector inactive_selector">
                            <h2>Sign Up</h2>
                        </div>
                    </div>
